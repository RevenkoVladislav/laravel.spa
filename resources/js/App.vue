...
<template>
    <div class="flex justify-between mt-6 mb-10 sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <router-link v-if="auth.user" :to="{ name: 'user.index' }" class="text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:outline-none font-medium rounded-lg text-sm px-4 py-2.5 text-center leading-5">Users</router-link>
        <router-link v-if="auth.user" :to="{ name: 'user.feed' }" class="text-white bg-gradient-to-r from-green-500 to-green-600 hover:bg-gradient-to-bl focus:outline-none font-medium rounded-lg text-sm px-4 py-2.5 text-center leading-5">Feed</router-link>
        <router-link v-if="auth.user" :to="{ name: 'user.liked-posts' }" class="text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:outline-none font-medium rounded-lg text-sm px-4 py-2.5 text-center leading-5">Liked Posts</router-link>
