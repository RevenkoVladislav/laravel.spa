...
export default {
    ...
    /**
     * Отправляем api запрос, делаем привязку лайка
     */
    methods: {
        toggleLike(post) {
            console.log(post);
            ...
            <div v-for="post in posts" :key="post.id"
                ...
                <div class="p-6">
                    ...
                    <div class="flex justify-between items-center mt-5">
                        <svg @click.prevent="toggleLike(post)" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" :class="['size-6 stroke-indigo-500 cursor-pointer hover:fill-indigo-500', post.is_liked ? 'fill-indigo-500' : 'fill-gray-100']">
